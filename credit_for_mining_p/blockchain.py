...
def mine():
    ...
    if blockchain.valid_proof(last_block_string, submitted_proof):
        ...
        blockchain.new_transaction(0, submitted_id, 1)
...
def recieve_block():
    ...
    if new_block['index'] == old_block['index'] + 1:
        ...
        if new_block['previous_hash'] == blockchain.hash(old_block):
            ...
            #hashes dont match, handle response
            pass
    else:
        #index is more than 1 greater
        #block may be invalid or we are behind
        #do consensus process
        #ask all nodes in network for chains
        #check their lengths and replace ours withthe longest VALID chain
        pass
